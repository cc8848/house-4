...
const defaults = {
  ...
  validate_float: '{name} 的值必须大于 {args}',
  ...
  validate_in: '{name} 的值必须是其中之一 {args}',
  validate_notIn: '{name} 的值不能是其中之一 {args}',
  validate_int: '{name} 必须是{args}之间的整型',
  validate_min: '{name} 必须是大于等于 {args} 的整型',
  validate_max: '{name} 必须是小于等于 {args} 的整型',
  ...
  validate_dateVal: '{name} 格式应为 YYYY-MM-DD HH:mm:ss',
};
module.exports = think.extend(defaults, error);
